...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-border bg-secondary/30 flex flex-col">
      <div className="px-5 h-16 border-b border-border flex items-center">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[10px] text-muted-foreground num uppercase tracking-wider mt-0.5">CoE AI · v1.0</div>
          </div>
        </Link>
      </div>
        ...
        <div className="space-y-px">
          {NAV.map(item => {
            ...
            return (
              ...
              >
                <Icon className={cn('h-3.5 w-3.5 stroke-[1.5]', active && 'text-primary')} />
      ...
      <div className="border-t border-border p-3">
        <Link
          href="/"
          target="_blank"
          className="flex items-center justify-between rounded-md px-2.5 py-1.5 text-xs text-muted-foreground hover:bg-card hover:text-foreground transition-colors"
        >
