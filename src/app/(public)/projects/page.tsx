          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t border-l border-border max-w-7xl">
            {projects.map((p: any) => (
              <Link
                ...
                className="border-r border-b border-border p-8 bg-card hover:bg-accent/30 transition-colors group flex flex-col"
              >
                ...
                <h3 className="display text-xl md:text-2xl text-foreground flex-1">{p.title}</h3>
